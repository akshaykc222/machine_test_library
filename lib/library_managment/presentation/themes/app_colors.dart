...
class AppColors {
  ...
  static const buttonColor = Color(0xff050049);
  static const primaryColor = Colors.white;
  static const red = Colors.red;
  static const barColor = Colors.blueAccent;
  static const grey = Colors.grey;
  static const bluegrey = Colors.blueGrey;
  static const primaryColors = Colors.white;
  //static const buttoncolor = Color(0xff000fff);
  static const backgroundcolor = Color(0xfffcfcfc);
  static const orange = Color(0xffff6565);
  static const cardcolor = Color(0xff2a4d83);
  static const blue = Colors.blue;
  static const black = Colors.black;
  static const cardblue1 = Color(0xff000846);
  static const cardblue2 = Color(0xff042a9a);
  ...
  static const lightLowBlue = Color(0xffadd8e6);
